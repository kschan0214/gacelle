...
% TODO: sort b and te and input full DWI
    ...
    properties
        ...
        modelParams     = { 'f';  'D';'R2a';'R2e'};
        ub              = [   1;    3;   50;  75];
        lb              = [1e-6; 1e-6;    1;   1];
        startPoint      = [ 0.6;    2;   12;  30];
    ...
    methods
        ...
        function display_data_model_info(this)
            ...
            disp('===================================================================');
            disp('Multi-compartment microscopic diffusion model with askadam.m solver');
            disp('===================================================================');
        ...
        % 
            ...
            % Remove all fields except 'D'
            if isfield(extraData,'D')
                fixedData = extraData.D;
            else
                fixedData = [];
            end
            ...
            for ks = 1:NSegment
                ...
                if ~isempty(fixedData); fields      = fieldnames(fixedData); for kfield = 1:numel(fields); extraData_tmp.(fields{kfield}) = fixedData.(fields{kfield})(:,:,slice,:,:,:,:,:,:,:,:); end
