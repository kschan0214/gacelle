classdef gpumcmicromcmc < handle
% Kwok-Shing Chan @ MGH
...
% TODO: sort b and te and input full DWI
    ...
    methods
        ...
        % constructuor
        function this = gpumcmicromcmc(b, te)
        ...
        %
            ...
            if nargin<2 || isempty(te)
                ...
                if isscalar(unique(te))
                    ...
                    this.te = gpuArray(single(te(:)));    % same length as b or scalar (if Nt==1)
                end
            end
        ...
        function display_data_model_info(this)
            ...
            disp('================================================================');
            disp('Multi-compartment microscopic diffusion model with mcmc.m solver');
            disp('================================================================');
        ...
        %
            ...
            mcmcObj     = mcmc(); 
            out         = mcmcObj.optimisation(dwi, mask, w, pars0, fitting, @this.FWD, extraData);
            %%%%%%%%%%%%%%%%%%%% End 2 %%%%%%%%%%%%%%%%%%%%
        ...
        function [this,dwi] = prepare_dwi_data(this,dwi,extradata,lmax)
            ...
            if size(dwi,4)/(lmax/2+1) > numel(this.b) 
                ...
                this.b  = gpuArray(single(bval_sorted));
                this.te = gpuArray(single(te_sorted));
