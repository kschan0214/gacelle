...
% Date modified: 
    ...
    methods
        ...
        % constructuor
        function this = gpuStick(b, ldelta, BDelta, Ds, varargin)
        ...
        function [dwi, mask] = prepare_dwi_data(this,dwi,mask,extradata,lmax)
            ...
            mask_valid         = and(mask,~mask_naninf);
            dwi = min(dwi,1);
        ...
        function S = Sl0(this,Da)
            ...
            S = this.GaussRotinv_l0(bval,Da, 0);
