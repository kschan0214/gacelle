...
% mcmc.goodman_weare (the affine-invariant ensemble sampler) directly
% against a user-supplied forward function, without going through any of
% GACELLE's built-in model classes (e.g. gpuNEXI, gpuAxCaliberSMT). Useful
% as a template for fitting a custom forward model outside the model-class
