...
% fixed SNR, and the parameters are recovered by calling mcmc.m's default
% ensemble sampler (fitting.algorithm='ensemble') directly against a
% user-supplied forward function, without going through any of GACELLE's
% built-in model classes (e.g. gpuNEXI, gpuAxCaliberSMT). Useful as a
% template for fitting a custom forward model outside the model-class
% framework. Recovered posterior means are plotted against ground truth.
%
