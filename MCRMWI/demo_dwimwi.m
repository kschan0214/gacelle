...
totalField  = niftiread(fullfile('/autofs/space/symphony_002/users/kwokshing/project/askadam/gpudimwi/bids/SEPIA/sub-002/ses-mri01/TR38NTE12/FA20',['sub-002_ses-mri01_acq-TR38NTE12FA20_run-1_MEGRE_space-withinGRE_EchoCombine-OW_total-field.nii.gz']));
...
[out_askadam4]    = objGPU.estimate(img, mask, extraData, fitting);
