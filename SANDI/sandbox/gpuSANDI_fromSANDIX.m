classdef gpuSANDI_fromSANDIX < handle
% Kwok-Shing Chan @ MGH
...
% Date modified: 
    ...
    methods
        ...
        % constructuor
        function this = gpuSANDI_fromSANDIX(b, ldelta, BDelta, Ds, varargin)
        ...
        function [x_train, S_train, intervals] = traindata(this, N_samples, lmax, varargin)
            ...
            for k = 1:reps
                ...
                for j = 1:batch_size
                    Sl0(:,j) = this.Sl0(pars(1,j), pars(2,j), pars(3,j), pars(4,j), 0, pars(5,j));
                end
