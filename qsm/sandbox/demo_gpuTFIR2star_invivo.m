...
mask = imerode(imfill( and(mask_lf,mask_reliable), 'holes'), strel('sphere',2));
...
objGPU = gpuTFIS0R2star(sepia_header.voxelSize, sepia_header.B0, sepia_header.B0_dir,sepia_header.TE);
% objGPU.Ps = 100;
