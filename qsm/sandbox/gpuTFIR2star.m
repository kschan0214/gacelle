...
% Date modified:
    ...
    methods
        ...
        % constructor
        function this = gpuTFIR2star(voxelSize,B0,B0dir,te)
        ...
        function [ data, mask, extraData ] = prepare_data(this, data, mask, extraData, fitting)
            ...
            tmp     = data(:,:,:,1);
            scale   = prctile(abs(tmp(mask)), 99);   % robust; max is noise-sensitive
            data    = data ./ scale;
    ...
    methods(Static)
        ...
        % both weights must be calibrated on your own data.
            ...
            if ~isfield(fitting,'TVmode');      fitting.TVmode      = 'anisotropic';    end
