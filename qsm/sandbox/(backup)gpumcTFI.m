...
% Date modified:
    ...
    methods
        ...
        %
            ...
            mag     = abs(data);
            Sn      = data ./ max(max(abs(mag(:))), eps('single'));
            data    = cat(5, real(Sn), imag(Sn));
            ...
            %               same phasor pair from the measured field.
            % switch fitting.isnonlinear
            %     case false
            %         f   = data ./ (this.gyro * this.B0);              % ppm
            %     case true
            %         phi = 2*pi*this.dTE .* data;                      % rad
    ...
    methods(Static)
        ...
        function r2s = R2star_trapezoidal(img,te)
