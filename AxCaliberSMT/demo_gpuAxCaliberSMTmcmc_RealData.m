...
% MCMC estimation
[out,a,f,fcsf,DeR,noise]    = smt_gpu.estimate(dwi, mask, extraData, fitting);
% reset GPU memory
reset(g)
...
g = gpuDevice;
smt_gpu                   = gpuAxCaliberSMTmcmc(bval_sorted, ldelta_sorted, BDELTA_sorted, D0, Da_fixed, DeL_fixed, Dcsf);
[~,a,f,fcsf,DeR,noise]    = smt_gpu.estimate(dwi, mask, extraData, fitting);
reset(g)
...
g = gpuDevice;
smt_gpu                   = gpuAxCaliberSMTmcmc(bval_sorted, ldelta_sorted, BDELTA_sorted, D0, Da_fixed, DeL_fixed, Dcsf);
[~,a,f,fcsf,DeR,noise]    = smt_gpu.estimate(dwi_smt, mask, extraData, fitting);
reset(g)
